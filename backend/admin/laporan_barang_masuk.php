    ...
    <div class="utama">
    	<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:10px;">
       		<tr>
                ...
                <td width="93%"><strong>&nbsp;Laporan Barang Masuk</strong></td>
            </tr>
            <tr>
        ...
        <table cellspacing="1" border="1" align="center" width="95%">
            ...
            <?php
				$no = 0;
            	$sql = mysql_query("SELECT * FROM tbl_barang_masuk GROUP BY kd_barang");
            ...
            <tr align="center">
                ...
                <td align="left" class="geser"><?php echo $data[1] ?></td>
                <td align="left" class="geser"><?php echo $data[2] ?></td>
                <td align="left" class="geser"><?php echo $data[3] ?></td>

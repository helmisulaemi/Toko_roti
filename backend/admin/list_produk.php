...
<div class="alert alert-warning" role="alert">
	<a href=""><span class="glyphicon glyphicon-home"></span> Home</a> 
 			   <i class="icon-angle-right"></i>  Pelanggan 
  			   <i class="icon-angle-right"></i>  List Produk
               <div class="right">
...
<script src="../../style/js/clock.js"></script>
    ...
    <form method="post">
      <table width="20%">
      		<tr>
                ...
                <td><a href="index.php?menu=listbr" class="btn btn-warning"><i class="icon-refresh"></i></a></td>
            </tr>
     </table>
     </form><br />
	<table class="table table-striped">
        ...
        <?php
		if(isset($_POST['cari'])){
			@$cari = "where nama_barang like '%$_POST[cari]%' or kd_barang like '%$_POST[cari]%' or jenis like '%$_POST[cari]%'";
		}
		$no = 0;
		@$a = $perintah->tampil("qw_barang $cari ORDER BY kd_barang DESC");
		if($a == ''){
        ...
        <tr>
            ...
            <td><div class="btn-group">
            		...
            		<a href="?menu=listbr&hapus&id=<?php echo $data[0]?>" class="btn btn-danger" 
		...
		if(isset($_GET['hapus'])){
			$perintah->hapus("tbl_barang","kd_barang = '$_GET[id]'","?menu=listbr");
		}
		?>
    </table>